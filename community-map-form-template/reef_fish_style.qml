...
<qgis styleCategories="AllStyleCategories" version="3.12.1-București" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08" readOnly="0">
  ...
  <referencedLayers>
    <relation name="reef_fish_feature" dataSource="./community-map-form.gpkg|layername=landscape_feature" layerId="landscape_feature_a72725d8_e955_4c84_8809_d042ce4e7166" providerKey="ogr" id="reef_fish__reef_fish_id_landscape__feature_id" strength="1" layerName="landscape feature">
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="Layer" type="QString" value="reef_fish_list_a285b400_170d_40b5_8728_36bb68a665df"/>
            <Option name="LayerName" type="QString" value="reef fish list"/>
            <Option name="LayerProviderName" type="QString" value="ogr"/>
            <Option name="LayerSource" type="QString" value="/Users/00094708/Dropbox (aciarlal)/ACIAR Livelihoods and Landscapes/research_activities/3_2/community-map-app/community-map-form/community-map-form/community-map-form.gpkg|layername=reef_fish_list"/>
  ...
  <aliases>
    ...
    <alias name="Reef / ocean fish species?" index="1" field="reef_fish"/>
    <alias name="Month(s) for reef / ocean fishing?" index="2" field="collection_month"/>
    <alias name="Observation about seasons for fish catch?" index="3" field="seasons"/>
    <alias name="Climatic stressors?" index="4" field="climate"/>
    <alias name="" index="5" field="reef_fish_id"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="reef_fish"/>
    ...
    <default expression="" applyOnUpdate="0" field="reef_fish_id"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" field="reef_fish" notnull_strength="0"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="reef_fish" hidden="0" type="field" width="-1"/>
      ...
      <column name="reef_fish_id" hidden="0" type="field" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer name="Reef / ocean fishing" visibilityExpression="" columnCount="1" showLabel="1" visibilityExpressionEnabled="0" groupBox="0">
      <attributeEditorField name="reef_fish" index="1" showLabel="1"/>
      ...
      <attributeEditorField name="reef_fish_id" index="5" showLabel="1"/>
  ...
  <editable>
    ...
    <field name="reef_fish" editable="1"/>
    <field name="reef_fish_id" editable="0"/>
  ...
  <labelOnTop>
    ...
    <field name="reef_fish" labelOnTop="0"/>
    <field name="reef_fish_id" labelOnTop="0"/>
