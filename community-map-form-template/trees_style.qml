...
<qgis styleCategories="AllStyleCategories" version="3.12.1-București" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08" readOnly="0">
  ...
  <referencedLayers>
    <relation name="trees_feature" dataSource="./community-map-form.gpkg|layername=landscape_feature" layerId="landscape_feature_a72725d8_e955_4c84_8809_d042ce4e7166" providerKey="ogr" id="trees_0882_tree_id_landscape__feature_id" strength="1" layerName="landscape feature">
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="Layer" type="QString" value="tree_list_0decd9fb_c28b_4cf5_88ec_4f9a1dfe79fb"/>
            <Option name="LayerName" type="QString" value="tree list"/>
            <Option name="LayerProviderName" type="QString" value="ogr"/>
            <Option name="LayerSource" type="QString" value="/Users/00094708/Dropbox (aciarlal)/ACIAR Livelihoods and Landscapes/research_activities/3_2/community-map-app/community-map-form/community-map-form/community-map-form.gpkg|layername=tree_list"/>
  ...
  <aliases>
    ...
    <alias name="Tree?" index="1" field="tree_name"/>
    ...
    <alias name="" index="6" field="tree_id"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="tree_name"/>
    ...
    <default expression="" applyOnUpdate="0" field="tree_id"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" field="tree_name" notnull_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" field="tree_id" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" field="year" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="fid"/>
    <constraint exp="" desc="" field="tree_name"/>
    ...
    <constraint exp="" desc="" field="tree_id"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="tree_name" hidden="0" type="field" width="-1"/>
      ...
      <column name="tree_id" hidden="0" type="field" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer name="Overview" visibilityExpression="" columnCount="1" showLabel="1" visibilityExpressionEnabled="0" groupBox="0">
      <attributeEditorField name="tree_name" index="1" showLabel="1"/>
      <attributeEditorField name="year" index="7" showLabel="1"/>
      <attributeEditorField name="climate" index="4" showLabel="1"/>
      <attributeEditorField name="tree_id" index="6" showLabel="1"/>
  ...
  <editable>
    ...
    <field name="tree_id" editable="1"/>
    <field name="tree_name" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="tree_id" labelOnTop="0"/>
    <field name="tree_name" labelOnTop="0"/>
    <field name="year" labelOnTop="0"/>
  </labelOnTop>
  <widgets/>
  <previewExpression>tree_name</previewExpression>
  <mapTip></mapTip>
